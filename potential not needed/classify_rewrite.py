...
def main():
    ...
    #HC_Sham_pts = ["pro00087153_0020", "pro00087153_0023", "pro00087153_0027", "pro00087153_0028", "pro00087153_0036"]
    #HC_Stim_pts = ["pro00087153_0022", "pro00087153_0024", "pro00087153_0025", "pro00087153_0026", "pro00087153_0029", "pro00087153_0030"]
    #CS_Sham_pts = ["pro00087153_0013", "pro00087153_0015", "pro00087153_0017", "pro00087153_0018", "pro00087153_0021"]
    CS_Stim_pts = ["pro00087153_0003", "pro00087153_0004", "pro00087153_0005", "pro00087153_0042", "pro00087153_0043"]
    pts = CS_Stim_pts
    all_x = []
    all_y = []
            ...
            for action in [Y_Value.HOLD, Y_Value.REACH]:
                for reach in range(len(metadata[trial][action.name.lower()])):
                    ...
                    for electrode, feature in zip(specified_electrodes, specified_features):
                        ...
                        if len(file_data.shape) == 1: # 0:1 for delta
                            x.append(file_data[0:1])
    ...
    for train_trial in range(10):
        ...
        for i in Class_Method:
            ...
            #save model
            models_dir = "./models/"
            filename = models_dir + current_model + str(train_trial) + ".sav"
        ...
        output_folder = pathlib.Path("./batch_results")
