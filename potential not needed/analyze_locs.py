...
for subject_folder in glob.glob('Subject_Data/*'):
    print("Running analysis on", subject_folder)

    # Load data, apply AC filters
    raw_edf = mne.io.read_raw_edf(subject_folder + f"/{subject_folder.split(os.sep)[1]}.edf")
    raw_edf.load_data()
