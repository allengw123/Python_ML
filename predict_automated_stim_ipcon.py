...
model_input = "/home/changal/Documents/bmi_allen_rishi/Stim_classification_group_CS/disease_prediction"
model_output = "/home/changal/Documents/bmi_allen_rishi/Stim_prediction_group_CS/disease_prediction"
feature_type = 'psdbin'
...
subject_list = all_patients['STROKE']
        ...
        for patient_name in pts:  # Extract Features
            ...
            for phase in phases:
                ...
                for electrode in specified_electrodes:
                    ...
                    feature_label = [
                        getattr(Stimulation_State, stim_label).value] * len(feature_val)
