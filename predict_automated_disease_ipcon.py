...
model_input = "/home/changal/Documents/bmi_allen_rishi/Model_classification_group_sham/disease_prediction"
model_output = "/home/changal/Documents/bmi_allen_rishi/Model_prediction/disease_prediction"
feature_type = 'psdbin'
...
for x in [1]:
    ...
    for state in ["intra5", "intra15", "post"]:
        ...
        for patient_name in pts:  # Extract Features
            ...
            for phase in phases:
                ...
                for electrode in specified_electrodes:
                    ...
                    disease_label = "HEALTHY" if patient_name in all_patients["HEALTHY"] else "STROKE"

                    #stim_label = "STIM" if patient_name in stim_type_patients["STIM"] else "SHAM"
                    feature_label = [
        ...
        # Make Results csv
        results = os.path.join(model_output + "Sham" + "_" + state)
